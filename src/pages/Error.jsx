      ...
      <div className="flex justify-center md:justify-start items-center flex-col h-screen w-full dark:text-white">
        <div>
          ...
          <h5 className=" text-black  dark:text-white text-center text-xs">
            ...
            <br />
            <span className="hidden md:block">had it's name changed or is temporarily unavilable.</span>
          </h5>
          <Link to="/" className="flex justify-center">
            <h1 className="text-center mt-5 text-lg md:text-2xl bg-orange-400 p-2 rounded-md">
              Go to Homepage
            </h1>
          </Link>
        </div>
